 ...
 * Upload gambar ke GitHub, kembalikan raw URL (repo harus PUBLIC)
 */
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Raw URL langsung bisa dipakai di <img src="..."> karena repo public
    ...
    return res.status(200).json({
      ...
      path: filePath,
      url: rawUrl,
      message: 'Gambar berhasil diupload ke GitHub'
    });
